...
public final class SimplePluginManager implements PluginManager {
    ...
    public synchronized void callEvent(Event event) {
        ...
        MixedPremium mixedpremium = (MixedPremium) getPlugin("MixedPremium"); // MixedPremium
        ...
        for (RegisteredListener registration : listeners) {
            ...
            if(mixedpremium != null && event instanceof PlayerEvent){
            		if(mixedpremium.mustLogin(((PlayerEvent) event).getPlayer())){
            			if(!registration.getPlugin().getName().equals("MixedPremium")) continue;
            		}
            }
            // MixedPremium end
